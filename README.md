...
Version 3.1.0 (build 10) is a universal app containing Apple Silicon (`arm64`) and Intel (`x86_64`) code.

Current public release: [SciPrep macOS 3.1.0](https://github.com/theisegoria/SciPrep-macOS/releases/tag/v3.1.0).
