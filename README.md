...
Version 1.2.1 (build 4) is a universal app containing Apple Silicon (`arm64`) and Intel (`x86_64`) code.

Current public release: [SciPrep macOS 1.2.1](https://github.com/theisegoria/SciPrep-macOS/releases/tag/v1.2.1).
